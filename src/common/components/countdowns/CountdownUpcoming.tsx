...
const CountdownUpcoming: React.FunctionComponent<CountdownProps> = ({ campaign, onMomentChange }) => {
  ...
  return (
    <div className={'w-fit text-[#131316]'}>
      <div
        className={'w-full flex justify-between items-center rounded-[12px] border border-[E7E7E8] bg-[#fff] p-1 gap-1'}
      >
...
export default CountdownUpcoming;
